...
public class DyDanMuConnect {

    private final Room room;
    private final MessageReceiveListener receiveListener;

    public DyDanMuConnect(Room room, MessageReceiveListener receiver) {
        this.room = room;
        this.receiveListener = receiver;
    }

    public static class MessageReceiveListener {
        public void onReceiver(DouYuDanMu douYuDanMu) {}
            ...
            final Thread heartBeatThread = new Thread(() -> {
                while (true) {
                    try {
                        ...
                        Thread.sleep(4500);        //心跳 斗鱼-45秒 虎牙-30秒
